...
prompt= console.print('''[yellow]
    ************** BRAIN Menu Version 2 Offline******[/yellow]
    *                                               *
...
while True:
    ...
    if address in add:
        ...
        console.print('[green]Bitcoin Address  [/green]',address)
        ...
        console.print('[red]Bitcoin Address  [/red] ', address + '[red] :ScanNumber:  [' + str(count) + '] [/red]')